...
public class InternetShopDemo {
    ...
    public static void main(String[] args) {
        ...
        lgn = "admin";
        psswd = "very complex";
        is.authorization(lgn, psswd);
        is.selectAndPutProductToBasket("Cloths", "Dress");
        is.selectAndPutProductToBasket("Cloths", "Anorak");
        is.selectAndPutProductToBasket("Cloths", "Dress");
        is.selectAndPutProductToBasket("Cloths", "Anorak");
        is.selectAndPutProductToBasket("Cloths", "T-Shirt");
        is.selectAndPutProductToBasket("Cloths", "Dress");
        is.selectAndPutProductToBasket("Cloths", "Anorak");
        is.selectAndPutProductToBasket("Cloths", "Anorak");
        is.selectAndPutProductToBasket("Cloths", "Dress");
            ...
            switch (choice) {
                ...
                case "2":
                    ...
                    while (isContinue) {
                        ...
                        System.out.println("6. Create a report");
